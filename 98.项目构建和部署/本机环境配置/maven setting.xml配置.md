...
<settings xmlns="http://maven.apache.org/SETTINGS/1.0.0"
	...
	<servers>
		...
		<!-- <server>
			...
			<password>weitexun@$1#</password>
			<configuration>
				<email>longxiaonan@163.com</email>
			</configuration>
		</server>
		...
		<server>
			<id>releases</id>
			<username>chenxiaomin</username>
			<password>chenxiaomin</password>
		</server>
		<server>
			<id>snapshots</id>
			<username>chenxiaomin</username>
	...
	<mirrors>
		<!-- mirror | Specifies a repository mirror site to use instead of a given 
		  ...
		  <mirror>
			...
			<url>http://120.79.246.166:7889/repository/open-report/</url>
		  </mirror>
		<mirror>
			<id>alimaven</id>
